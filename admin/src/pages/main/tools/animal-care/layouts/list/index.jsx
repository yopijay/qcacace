...
const Index = () => {
    ...
    const { isFetching: fetching } = 
        useGet({ key: ['animal_care_list'], fetch: records({ table: 'tbl_animal_care', data: {} }), options: { refetchOnWindowFocus: false }, onSuccess: (data) => setList(data) });
        ...
        <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch" sx= {{ width: '100%', height: '100%' }} spacing= { 3 }>
            <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch" spacing= { 1 }>
                ...
                <Stack direction= "row" justifyContent= "space-between" alignItems= "center">
                    ...
                    <Box>
                        <Typography component= { Link } to= "/tools/animalcare/form/new" sx= { btnicon }><FontAwesomeIcon icon= { solid('plus') } style= {{ color: '#FFFFFF' }} /></Typography>
                        <Typography component= { Link } to= "/tools/animalcare/form/new" sx= { btntxt }>New Animal Care</Typography>
                    </Box>
                </Stack>
            </Stack>
