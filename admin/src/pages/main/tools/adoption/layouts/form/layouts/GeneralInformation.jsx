        ...
        <Grid container direction= "row" justifyContent= "flex-start" alignItems= "flex-start" sx= {{ padding: { xs: '0 15px', sm: '0 35px' } }}>
            ...
            <Grid item xs= { 12 } md= { 6 }>
                <Stack direction= "column" justifyContent= "flex-start" alignItems= "flex-end">
                    <Typography>Date of Application: <span style= {{ fontWeight: 'bold', textTranform: 'uppercase' }}>{ id !== undefined ? getDate(new Date(getValues().date_requested)).formatted : getDate(new Date()).formatted }</span></Typography>
                </Stack>
            </Grid>
            <Grid item xs= { 12 }>
