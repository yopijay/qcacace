        ...
        <AppBar position= "fixed" sx= { appbar }>
            <Container maxWidth= "lg">
                <Stack direction= "row" justifyContent= "space-between" alignItems= "center" spacing= { 1 }>
                    <Stack direction= "row" justifyContent= "flex-start" alignItems= "center" spacing= { 1 } component= { Link } to= "/" onClick= { () => { localStorage.setItem('nav', 'home'); setIsActive('home'); } } sx= {{ textDecoration: 'none' }}>
                    ...
                    <Stack direction= "row" justifyContent= "flex-end" alignItems= "center" spacing= { 4 } sx= {{ display: { xs: 'none', md: 'flex' } }}>
                        ...
                        <Typography variant= "body2" sx= { isActive === 'pets' ? activeLink : link } component= { Link } to= "/pets" onClick= { () => { localStorage.setItem('nav', 'pets'); setIsActive('pets'); } }>Pet Gallery</Typography>
                        <Typography variant= "body2" sx= { isActive === 'services' ? activeLink : link } component= { Link } to= "/services" onClick= { () => { localStorage.setItem('nav', 'services'); setIsActive('services'); } }>Services</Typography>
                        <Typography variant= "body2" sx= { isActive === 'faqs' ? activeLink : link } component= { Link } to= "/faqs" onClick= { () => { localStorage.setItem('nav', 'faqs'); setIsActive('faqs'); } }>FAQs</Typography>
                    </Stack>
                </Stack>
            </Container>
        </AppBar>
