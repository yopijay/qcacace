        ...
        <Grid container direction= "row" justifyContent= "flex-start" alignItems= "flex-start" spacing= { 1 } sx= {{ padding: { xs: '0 15px', sm: '0 35px' } }}>
            <Grid item xs= { 12 } sm= { 4 }>
                <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch">
                    ...
                    <ThemeProvider theme= { theme }><TextField { ...register('applicant.fname') } name= "applicant.fname" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } /></ThemeProvider>
            ...
            <Grid item xs= { 12 } sm= { 4 }>
                <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch">
                    ...
                    <ThemeProvider theme= { theme }><TextField { ...register('applicant.mname') } name= "applicant.mname" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } /></ThemeProvider>
            ...
            <Grid item xs= { 12 } sm= { 4 }>
                <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch">
                    ...
                    <ThemeProvider theme= { theme }><TextField { ...register('applicant.lname') } name= "applicant.lname" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } /></ThemeProvider>
            ...
            <Grid item xs= { 12 } sm= { 4 }>
                <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch">
                    ...
                    <ThemeProvider theme= { theme }><TextField { ...register('applicant.contact_no') } name= "applicant.contact_no" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } /></ThemeProvider>
            ...
            <Grid item xs= { 12 } sm= { 6 }>
                <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch">
                    ...
                    <TextField { ...register('applicant.email') } name= "applicant.email" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } />
            ...
            <Grid item xs= { 12 }>
                <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch">
                    ...
                    <ThemeProvider theme= { theme }><TextareaAutosize name= "applicant.address" { ...register('applicant.address') } minRows= { 4 } maxRows= { 4 } style= { textarea } /></ThemeProvider>
                </Stack>
            </Grid>
        </Grid>
    );
