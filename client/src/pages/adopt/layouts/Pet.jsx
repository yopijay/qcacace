...
const Pet = () => {
    ...
    useGet(['pet_specific'], get({ table: 'tbl_pets', type: 'specific', query: localStorage.getItem('adopt') }), { refetchOnWindowFocus: false }, 
        (data) => {
            setValue('pet.series_no', data[0].series_no);
            setValue('pet.name', data[0].name);
            setValue('pet.category_id', data[0].category_id);
            setValue('pet.breed_id', data[0].breed_id);
            setValue('pet.gender', data[0].gender);
            setValue('pet.age', data[0].age);
            setValue('pet.size', data[0].size);
            setValue('pet.color', data[0].color);
        });
