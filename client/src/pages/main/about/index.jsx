        ...
        <Grid container direction= "column" justifyContent= "flex-start" alignItems= "stretch" sx= {{ padding: '20px 0' }}>
            ...
            </Grid>
            {
                About().map((item, index) => (
                    <Grid item key= { index }>
                        <Grid container direction= { index % 2 === 0 ? 'row' : 'row-reverse' } justifyContent= "space-evenly" alignItems= "center" sx= {{ padding: '20px 0' }}>
                            <Grid item xs= { 6 } sm= { 5 } md= { 3 } lg= { 3 }><img src= { item.img } alt= { item.alt } width= "100%" height= "auto" /></Grid>
                            <Grid item xs= { 12 } sm= { 7 } md= { 6 } lg= { 5 }>
                                <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch" spacing= { 2 }>
                                    ...
                                    <Box sx= {{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}><Typography component= { Link } href= { item.link } target= "_blank" sx= { itemLink }>Learn more</Typography></Box>
                                </Stack>
                            </Grid>
                        </Grid>
                    </Grid>
