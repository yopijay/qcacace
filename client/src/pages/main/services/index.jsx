            ...
            <Grid item sx= {{ padding: '20px 0' }}>
                <Grid container direction= "row" justifyContent= "center" alignItems= "center" spacing= { 2 }>
                    <Grid item xs= { 12 } md= { 4 } sx= {{ padding: '2px' }}>
                        <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch" spacing= { 2 } sx= {{ padding: '30px 25px', boxShadow: 1, borderRadius: '7px', minHeight: '360px', backgroundColor: '#ffffff' }}>
