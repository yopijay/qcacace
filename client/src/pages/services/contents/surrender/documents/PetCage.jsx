...
const PetCage = () => {
    ...
    useEffect(() => { register('pet_cage'); }, [ register ]);
    return (
        <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch" spacing= { 1 }>
            <Typography gutterBottom sx= {{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>*Picture Of House's Outside And Inside, Showing
